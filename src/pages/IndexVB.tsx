          ...
          <div className="max-w-5xl mx-auto">
            <SR>
              <div
                ...
                style={{
                  background: "linear-gradient(135deg, #0B2F4A 0%, #0F1115 100%)",
                  border: "1px solid rgba(255,255,255,0.10)",
                }}
              >
                <div
                ...
                />
                <div
                  className="absolute -bottom-24 -right-24 w-72 h-72 rounded-full blur-[100px] pointer-events-none"
                ...
                <div className="relative">
                  ...
                  <h2
                    className="text-3xl md:text-4xl lg:text-5xl font-extrabold tracking-tighter mb-4 max-w-2xl mx-auto"
                    style={{ color: "white" }}
                  >
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                    <a
                      ...
                      className="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-8 py-4 rounded-full text-base font-bold transition-all hover:-translate-y-0.5"
                      style={{
                        background: EMERALD,
                        color: "#0F1115",
                        boxShadow: "0 12px 40px -10px rgba(16,185,129,0.55)",
