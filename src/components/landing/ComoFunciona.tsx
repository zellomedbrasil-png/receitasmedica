...
const steps = [
  { num: "1", title: "Triagem Digital", desc: "Preencha seus dados e envie foto da receita anterior ou laudo.", Icon: ClipboardCheck, dark: false },
  { num: "2", title: "Teleconsulta", desc: "Vídeo chamada rápida com médico para validar a continuidade.", Icon: Video, dark: false },
  { num: "3", title: "Receita no WhatsApp", desc: "Link com assinatura digital enviado direto para seu celular.", Icon: MessageCircle, dark: true },
];
              ...
              >
                ...
                <step.Icon
                  className={`absolute -bottom-4 -right-4 w-[140px] h-[140px] -rotate-[15deg] transition-colors duration-500 ${
                    step.dark ? "text-white/5" : "text-slate-200 group-hover:text-primary/10"
                  }`}
                  strokeWidth={0.5}
                />
                {step.dark && (
